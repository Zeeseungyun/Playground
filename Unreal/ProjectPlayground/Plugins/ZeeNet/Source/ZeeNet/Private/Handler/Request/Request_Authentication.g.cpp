...
FZeeNetRequestHandlerArray* FindHandler_Authentication(int32 Point, TMap<const TCHAR*, FZeeNetRequestHandlerArray>& RequestHandlers) { 
	switch (Point) { 
...
EZeeNetRequestHandlerResponse ConsumeRequestMessage_Authentication(TSharedPtr<struct FZeeNetPacketSerializerBase> Packet, FZeeNetRequestHandlerArray& RequestHandlers) {
