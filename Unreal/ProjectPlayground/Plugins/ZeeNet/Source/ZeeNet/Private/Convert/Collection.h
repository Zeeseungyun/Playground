...
{ 
	template<> struct TZeeNetMapping_ProtoToPoint<Zee::Proto::Collection::Collect> { static constexpr int32 Point = 0x3001; }; 
	...
	template<> struct TZeeNetMapping_ProtoToPoint<Zee::Proto::Collection::Get> { static constexpr int32 Point = 0x3002; }; 
