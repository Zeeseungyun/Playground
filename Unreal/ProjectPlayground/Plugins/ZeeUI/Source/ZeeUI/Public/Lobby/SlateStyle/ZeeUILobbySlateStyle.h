...
public:
	...
	static const FZeeUILobbySlateStyle& GetDefault();
...
class UZeeUILobbySlateStyleContainer : public USlateWidgetStyleContainerBase
{
	GENERATED_BODY()
...
public:
	...
	FZeeUILobbySlateStyle LobbySlateStyle;

	// Retrievs the style that this container manages. 
	virtual const struct FSlateWidgetStyle* const GetStyle() const override
	{
		return static_cast<const struct FSlateWidgetStyle*>(&LobbySlateStyle);
	}
