...
struct Z_Construct_UEnum_ZeeNet_EZeeNetChatReturnCode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "SUCCESS.Name", "EZeeNetChatReturnCode::SUCCESS" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EZeeNetChatReturnCode::SUCCESS", (int64)EZeeNetChatReturnCode::SUCCESS },
	};
...
struct Z_CompiledInDeferFile_FID_ProjectPlayground_Plugins_ZeeNet_Source_ZeeNet_Public_Messages_Chat_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EZeeNetChatReturnCode_StaticEnum, TEXT("EZeeNetChatReturnCode"), &Z_Registration_Info_UEnum_EZeeNetChatReturnCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 511509155U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FZeeNetChatSpeak::StaticStruct, Z_Construct_UScriptStruct_FZeeNetChatSpeak_Statics::NewStructOps, TEXT("ZeeNetChatSpeak"), &Z_Registration_Info_UScriptStruct_ZeeNetChatSpeak, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FZeeNetChatSpeak), 2387656953U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectPlayground_Plugins_ZeeNet_Source_ZeeNet_Public_Messages_Chat_h_1211058308(TEXT("/Script/ZeeNet"),
	nullptr, 0,
