...
{ 
	template<> struct TZeeNetMapping_ProtoToPoint<Zee::Proto::Dedicate::Login> { static constexpr int32 Point = 0x4001; }; 
	...
	template<> struct TZeeNetMapping_ProtoToPoint<Zee::Proto::Dedicate::Move> { static constexpr int32 Point = 0x4002; }; 
	...
	template<> struct TZeeNetMapping_ProtoToPoint<Zee::Proto::Dedicate::Leave> { static constexpr int32 Point = 0x4003; }; 
